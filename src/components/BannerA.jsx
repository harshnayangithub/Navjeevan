      ...
      <div className='absolute inset-0 bg-black bg-opacity-70 flex items-center justify-center'>
        <div className='max-w-[1240px] py-[30px] mx-auto text-center font-bold'>
          ...
          Learn More
            ...
            <button className="w-full md:w-1/4 bg-[#df9c00f3] hover:text-[#DD761C] hover:scale-105 transition-transform duration-200 my-2 text-white p-3.5 justify-center rounded">
