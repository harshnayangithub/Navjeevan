...
export default function Newsletter() {
  return (
    <div className='md:flex justify-center items-center max-w-full m-100px py-[30px] md:py-[100px] p-30px mx-auto bg-cover bg-center' style={{ backgroundImage: `url(${Home})` }}>
